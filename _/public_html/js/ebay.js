document.addEventListener("DOMContentLoaded", () => {
    ...
    const loadEbayListings = async () => {
        try {
            ...
            // Fetch eBay listings from the backend
            const response = await fetch(
                `https://promanaged-it.com/php/ebay_items.php?${params.toString()}`
            );
